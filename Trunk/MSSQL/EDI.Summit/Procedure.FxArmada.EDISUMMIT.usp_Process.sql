...
/*
Create Procedure.FxArmada.EDISUMMIT.usp_Process.sql
*/

use FxArmada
go

if	objectproperty(object_id('EDISUMMIT.usp_Process'), 'IsProcedure') = 1 begin
	drop procedure EDISUMMIT.usp_Process
end
go
