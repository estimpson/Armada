...
/*
Create Procedure.FxArmada.dbo.usp_ShipNotice_NOVEM.sql
*/

use FxArmada
go

if	objectproperty(object_id('dbo.usp_ShipNotice_NOVEM'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_ShipNotice_NOVEM
end
go
...
execute
	@ProcReturn = dbo.usp_ShipNotice_NOVEM
	@ShipperID = @ShipperID
,	@TranDT = @TranDT out
