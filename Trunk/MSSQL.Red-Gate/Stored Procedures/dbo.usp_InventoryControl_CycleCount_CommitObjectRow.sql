...
if	@RowCount != 1 begin
	set	@Result = 999999
	RAISERROR ('Error selecting from table %s in procedure %s.  Rows selected: %d.  Expected rows: 1.', 16, 1, @TableName, @ProcName, @RowCount)
	rollback tran @ProcName
	return
end
--- </Select>
...
if	@ccoStatus > 0 and
	...
	--- <Call>	
	set	@CallProcName = 'dbo.usp_InventoryControl_ManualAdd'
	execute
