...
Create procedure [EDIGRAM].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIGRAM.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDIGRAM.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIGRAM.ShipScheduleSupplemental'

insert
	EDIGRAM.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGRAM.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIGRAM.ShipScheduleAccums'

insert
	EDIGRAM.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGRAM.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIGRAM.ShipScheduleAuthAccums'

insert
	EDIGRAM.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGRAM.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIGRAM.ShipSchedules'

insert
	EDIGRAM.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIGRAM.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIGRAM.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIGRAM.PlanningSupplemental'

insert
	EDIGRAM.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGRAM.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIGRAM.PlanningAccums'

insert
	EDIGRAM.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGRAM.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIGRAM.PlanningAuthAccums'

insert
	EDIGRAM.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGRAM.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDIGRAM.StagingPlanningReleasesT sfr
...
truncate table
	EDIGRAM.StagingShipScheduleHeadersT
truncate table
	EDIGRAM.StagingShipScheduleSupplementalT
truncate table
	EDIGRAM.StagingShipScheduleAccumsT
truncate table
	EDIGRAM.StagingShipScheduleAuthAccumsT
truncate table
	EDIGRAM.StagingShipSchedulesT
truncate table
	EDIGRAM.StagingPlanningHeadersT
truncate table
	EDIGRAM.StagingPlanningSupplementalT
truncate table
	EDIGRAM.StagingPlanningAccumsT
truncate table
	EDIGRAM.StagingPlanningAuthAccumsT
truncate table
	EDIGRAM.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGRAM.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIGRAM.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIGRAM.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIGRAM.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIGRAM.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIGRAM.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIGRAM.ShipSchedules sdrv
...
select
	*
from
	EDIGRAM.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIGRAM.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIGRAM.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIGRAM.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIGRAM.PlanningReleases sdrv
go
