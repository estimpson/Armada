...
--	Argument Validation:
--		ReceiverObjectID is valid and received.
if
	(	select
			Status
		from
...
if	@ReceiverType in (1, 3) begin --Purchase Order, Outside Processing
	--- <Call>	
	...
	--- <Call>	
	set	@CallProcName = 'dbo.usp_ReceivingDock_UndoRMAReceiveObjects'
	execute @ProcReturn = dbo.usp_ReceivingDock_UndoRMAReceiveObjects 
		@User = @User
	,	@RMA_ID = @PONumber
	,	@RMA_LineID = @POLineNo
	,	@PartCode = @PartCode
...
if	@ReceiverType = 3 begin -- 'Outside Process'
