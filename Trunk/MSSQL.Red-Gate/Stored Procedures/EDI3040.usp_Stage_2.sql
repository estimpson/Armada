...
CREATE procedure [EDI3040].[usp_Stage_2]
...
set	@ProcName = user_name(objectproperty(@@procid, 'OwnerId')) + '.' + object_name(@@procid)  -- e.g. EDI3040.usp_Test
--- </Error Handling>
...
execute
	...
	@objname = N'EDI3040.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.ShipScheduleHeaders'

insert
	EDI3040.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI3040.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.ShipScheduleSupplemental'

insert
	EDI3040.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.ShipScheduleAccums'

insert
	EDI3040.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.ShipScheduleAuthAccums'

insert
	EDI3040.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.ShipSchedules'

insert
	EDI3040.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDI3040.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.PlanningHeaders'

insert
	EDI3040.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI3040.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.PlanningSupplemental'

insert
	EDI3040.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.PlanningAccums'

insert
	EDI3040.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.PlanningAuthAccums'

insert
	EDI3040.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3040.PlanningReleases'

insert
	EDI3040.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDI3040.StagingPlanningReleasesT sfr
...
truncate table
	EDI3040.StagingShipScheduleHeadersT
truncate table
	EDI3040.StagingShipScheduleSupplementalT
truncate table
	EDI3040.StagingShipScheduleAccumsT
truncate table
	EDI3040.StagingShipScheduleAuthAccumsT
truncate table
	EDI3040.StagingShipSchedulesT
truncate table
	EDI3040.StagingPlanningHeadersT
truncate table
	EDI3040.StagingPlanningSupplementalT
truncate table
	EDI3040.StagingPlanningAccumsT
truncate table
	EDI3040.StagingPlanningAuthAccumsT
truncate table
	EDI3040.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDI3040.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI3040.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI3040.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI3040.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI3040.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI3040.ShipSchedules sdrv
...
select
	*
from
	EDI3040.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI3040.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI3040.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI3040.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI3040.PlanningReleases sdrv
go
