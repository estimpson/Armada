CREATE TABLE [EDI3040].[StagingShipScheduleSupplemental]
(
[Status] [int] NOT NULL CONSTRAINT [DF__StagingSh__Statu__60D92C50] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__StagingShi__Type__61CD5089] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__StagingSh__RowCr__62C174C2] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__StagingSh__RowCr__63B598FB] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__StagingSh__RowMo__64A9BD34] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__StagingSh__RowMo__659DE16D] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI3040].[StagingShipScheduleSupplemental] ADD CONSTRAINT [PK__StagingS__FFEE7450E947CC6B] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
