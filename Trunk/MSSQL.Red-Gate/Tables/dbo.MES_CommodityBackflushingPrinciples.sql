...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MES_Commo__RowCr__308FCB47] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__MES_Commo__RowMo__3183EF80] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MES_Commo__RowMo__327813B9] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'MES_CommodityBackflushingPrinciples', 'CONSTRAINT', N'UQ__MES_Comm__FA0D573E2AD6F1F1'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'643317537', 'SCHEMA', N'dbo', 'TABLE', N'MES_CommodityBackflushingPrinciples', 'CONSTRAINT', N'UQ__MES_Comm__FA0D573E2AD6F1F1'
GO
