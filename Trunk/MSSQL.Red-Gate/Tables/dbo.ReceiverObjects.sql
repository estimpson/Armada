...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ReceiverO__LastU__0AE879F5] DEFAULT (suser_sname()),
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'ReceiverObjects', 'CONSTRAINT', N'UQ__Receiver__6A303F350623C4D8'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'2086943815', 'SCHEMA', N'dbo', 'TABLE', N'ReceiverObjects', 'CONSTRAINT', N'UQ__Receiver__6A303F350623C4D8'
GO
