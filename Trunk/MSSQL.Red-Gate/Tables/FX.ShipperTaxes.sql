...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ShipperTa__LastU__1E8F7FEF] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__ShipperTa__LastD__1F83A428] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__ShipperTa__RowGU__2077C861] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperTaxes', 'CONSTRAINT', N'UQ__ShipperT__B174D9DD18D6A699'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'675369640', 'SCHEMA', N'FX', 'TABLE', N'ShipperTaxes', 'CONSTRAINT', N'UQ__ShipperT__B174D9DD18D6A699'
GO
