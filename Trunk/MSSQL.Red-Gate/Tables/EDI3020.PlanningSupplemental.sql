...
(
[Status] [int] NOT NULL CONSTRAINT [DF__PlanningS__Statu__07A78857] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__PlanningSu__Type__089BAC90] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__PlanningS__RowCr__098FD0C9] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__PlanningS__RowCr__0A83F502] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__PlanningS__RowMo__0B78193B] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__PlanningS__RowMo__0C6C3D74] DEFAULT (suser_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI3020].[PlanningSupplemental] ADD CONSTRAINT [PK__Planning__FFEE7451133B0997] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
