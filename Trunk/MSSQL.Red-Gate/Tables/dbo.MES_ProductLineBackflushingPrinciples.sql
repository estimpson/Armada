...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MES_Produ__RowCr__2335D029] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__MES_Produ__RowMo__2429F462] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MES_Produ__RowMo__251E189B] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'MES_ProductLineBackflushingPrinciples', 'CONSTRAINT', N'UQ__MES_Prod__8C0969521D7CF6D3'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'368679861', 'SCHEMA', N'dbo', 'TABLE', N'MES_ProductLineBackflushingPrinciples', 'CONSTRAINT', N'UQ__MES_Prod__8C0969521D7CF6D3'
GO
