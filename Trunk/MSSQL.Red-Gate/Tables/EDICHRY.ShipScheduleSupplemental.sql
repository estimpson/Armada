...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__200921CD] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__20FD4606] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__21F16A3F] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__22E58E78] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__23D9B2B1] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__24CDD6EA] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDICHRY].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE74504BED0FED] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
