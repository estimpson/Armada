...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__OutsidePr__LastU__1AF3F935] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__OutsidePr__LastD__1BE81D6E] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__OutsidePr__RowGU__1CDC41A7] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'OutsideProcessShipperHeaders', 'CONSTRAINT', N'UQ__OutsideP__B174D9DD17236851'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'559575613', 'SCHEMA', N'FX', 'TABLE', N'OutsideProcessShipperHeaders', 'CONSTRAINT', N'UQ__OutsideP__B174D9DD17236851'
GO
