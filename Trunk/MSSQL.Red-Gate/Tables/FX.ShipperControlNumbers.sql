...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ShipperCo__LastU__4B973090] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__ShipperCo__LastD__4C8B54C9] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__ShipperCo__RowGU__4D7F7902] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperControlNumbers', 'CONSTRAINT', N'UQ__ShipperC__B174D9DD46D27B73'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1991826838', 'SCHEMA', N'FX', 'TABLE', N'ShipperControlNumbers', 'CONSTRAINT', N'UQ__ShipperC__B174D9DD46D27B73'
GO
