...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__SalesShip__LastU__32CB82C6] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__SalesShip__LastD__33BFA6FF] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__SalesShip__RowGU__34B3CB38] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'SalesShipperHeaders', 'CONSTRAINT', N'UQ__SalesShi__B174D9DD2E06CDA9'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-854693760', 'SCHEMA', N'FX', 'TABLE', N'SalesShipperHeaders', 'CONSTRAINT', N'UQ__SalesShi__B174D9DD2E06CDA9'
GO
