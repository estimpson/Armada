...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'shop_floor_calendar', 'CONSTRAINT', N'UQ__shop_flo__02019A08595B4002'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'2837442123', 'SCHEMA', N'dbo', 'TABLE', N'shop_floor_calendar', 'CONSTRAINT', N'UQ__shop_flo__02019A08595B4002'
GO
