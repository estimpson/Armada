CREATE TABLE [dbo].[deduction_adjustments]
(
...
[deduction_type] [varchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[deduction_adjustments] ADD CONSTRAINT [pk_deduction_adjustments] PRIMARY KEY CLUSTERED  ([employee], [payroll_date], [entry_datetime], [adjustment_identity]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [deduction_adj_cycle_employee] ON [dbo].[deduction_adjustments] ([payroll_cycle], [employee], [voucher]) ON [PRIMARY]
GO
