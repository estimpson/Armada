...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__location__RowCre__54FCD850] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NULL CONSTRAINT [DF__location__RowCre__55F0FC89] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__location__RowMod__56E520C2] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NULL CONSTRAINT [DF__location__RowMod__57D944FB] DEFAULT (suser_name())
) ON [PRIMARY]
GO
