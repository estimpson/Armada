...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MES_PartB__RowCr__0881D9ED] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__MES_PartB__RowMo__0975FE26] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MES_PartB__RowMo__0A6A225F] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'MES_PartBackflushingPrinciples', 'CONSTRAINT', N'UQ__MES_Part__A15FB69502C90097'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1906705500', 'SCHEMA', N'dbo', 'TABLE', N'MES_PartBackflushingPrinciples', 'CONSTRAINT', N'UQ__MES_Part__A15FB69502C90097'
GO
