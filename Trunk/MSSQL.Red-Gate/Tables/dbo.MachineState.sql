...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MachineSt__RowCr__1447C6FD] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__MachineSt__RowMo__153BEB36] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MachineSt__RowMo__16300F6F] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'MachineState', 'CONSTRAINT', N'UQ__MachineS__DB84B5B80F8311E0'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-172993800', 'SCHEMA', N'dbo', 'TABLE', N'MachineState', 'CONSTRAINT', N'UQ__MachineS__DB84B5B80F8311E0'
GO
