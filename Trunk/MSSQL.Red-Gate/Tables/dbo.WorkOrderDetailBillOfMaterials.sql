...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowCr__0CC6A0C6] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__WorkOrder__RowMo__0DBAC4FF] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowMo__0EAEE938] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[WorkOrderDetailBillOfMaterials] ADD CONSTRAINT [FK__WorkOrderDetailB__0FA30D71] FOREIGN KEY ([WorkOrderNumber], [WorkOrderDetailLine]) REFERENCES [dbo].[WorkOrderDetails] ([WorkOrderNumber], [Line])
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderDetailBillOfMaterials', 'CONSTRAINT', N'UQ__WorkOrde__96B35E23033D368C'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'759990489', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderDetailBillOfMaterials', 'CONSTRAINT', N'UQ__WorkOrde__96B35E23033D368C'
GO
