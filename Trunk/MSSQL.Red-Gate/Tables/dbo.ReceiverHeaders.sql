...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ReceiverH__LastU__0A338187] DEFAULT (suser_sname()),
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'ReceiverHeaders', 'CONSTRAINT', N'UQ__Receiver__B35701C20662F0A3'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-524478023', 'SCHEMA', N'dbo', 'TABLE', N'ReceiverHeaders', 'CONSTRAINT', N'UQ__Receiver__B35701C20662F0A3'
GO
