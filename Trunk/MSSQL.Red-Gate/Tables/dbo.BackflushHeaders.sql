...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Backflush__RowCr__6F963092] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__Backflush__RowMo__708A54CB] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Backflush__RowMo__717E7904] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[BackflushHeaders] ADD CONSTRAINT [FK__BackflushHeaders__72729D3D] FOREIGN KEY ([WorkOrderNumber], [WorkOrderDetailLine]) REFERENCES [dbo].[WorkOrderDetails] ([WorkOrderNumber], [Line])
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'BackflushHeaders', 'CONSTRAINT', N'UQ__Backflus__1DA70F8B69DD573C'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1939222567', 'SCHEMA', N'dbo', 'TABLE', N'BackflushHeaders', 'CONSTRAINT', N'UQ__Backflus__1DA70F8B69DD573C'
GO
