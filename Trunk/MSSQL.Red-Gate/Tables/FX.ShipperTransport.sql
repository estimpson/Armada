...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ShipperTr__LastU__2EC5E7B8] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__ShipperTr__LastD__2FBA0BF1] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__ShipperTr__RowGU__30AE302A] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperTransport', 'CONSTRAINT', N'UQ__ShipperT__B174D9DD290D0E62'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1574590179', 'SCHEMA', N'FX', 'TABLE', N'ShipperTransport', 'CONSTRAINT', N'UQ__ShipperT__B174D9DD290D0E62'
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperTransport', 'CONSTRAINT', N'UQ__ShipperT__E058D7542630A1B7'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'712734068', 'SCHEMA', N'FX', 'TABLE', N'ShipperTransport', 'CONSTRAINT', N'UQ__ShipperT__E058D7542630A1B7'
GO
