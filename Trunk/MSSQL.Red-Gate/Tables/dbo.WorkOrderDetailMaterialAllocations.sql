...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowCr__3A6D6FE5] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__WorkOrder__RowMo__3B61941E] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowMo__3C55B857] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderDetailMaterialAllocations', 'CONSTRAINT', N'UQ__WorkOrde__28DD15A031D829E4'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-1582312797', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderDetailMaterialAllocations', 'CONSTRAINT', N'UQ__WorkOrde__28DD15A031D829E4'
GO
