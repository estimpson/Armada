CREATE TABLE [dbo].[fa_asset_attributes]
(
...
GO
ALTER TABLE [dbo].[fa_asset_attributes] ADD CONSTRAINT [pk_fa_asset_attributes] PRIMARY KEY CLUSTERED  ([asset_id]) ON [PRIMARY]
GO
