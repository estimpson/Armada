...
(
[Status] [int] NOT NULL CONSTRAINT [DF__StagingSh__Statu__44E5A0C1] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__StagingShi__Type__45D9C4FA] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__StagingSh__RowCr__46CDE933] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__StagingSh__RowCr__47C20D6C] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__StagingSh__RowMo__48B631A5] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__StagingSh__RowMo__49AA55DE] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI3010].[StagingShipScheduleSupplemental] ADD CONSTRAINT [PK__StagingS__FFEE745007ED1EC1] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
