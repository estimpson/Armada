...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__bill_of_m__LastU__1B0907CE] DEFAULT (suser_sname()),
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'bill_of_material_ec', 'CONSTRAINT', N'UQ__bill_of___3214EC261920BF5C'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-1550930493', 'SCHEMA', N'dbo', 'TABLE', N'bill_of_material_ec', 'CONSTRAINT', N'UQ__bill_of___3214EC261920BF5C'
GO
