...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ShipperOb__LastU__03DB89B3] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__ShipperOb__LastD__04CFADEC] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__ShipperOb__RowGU__05C3D225] DEFAULT (newid())
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperObjects', 'CONSTRAINT', N'UQ__ShipperO__B174D9DD7D2E8C24'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1835859187', 'SCHEMA', N'FX', 'TABLE', N'ShipperObjects', 'CONSTRAINT', N'UQ__ShipperO__B174D9DD7D2E8C24'
GO
