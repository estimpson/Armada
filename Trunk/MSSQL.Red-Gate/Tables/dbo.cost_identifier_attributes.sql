CREATE TABLE [dbo].[cost_identifier_attributes]
(
...
GO
ALTER TABLE [dbo].[cost_identifier_attributes] ADD CONSTRAINT [pk_cost_identifier_attributes] PRIMARY KEY CLUSTERED  ([cost_id], [cost_sub]) ON [PRIMARY]
GO
