...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowCr__7094766C] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__WorkOrder__RowMo__71889AA5] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowMo__727CBEDE] DEFAULT (suser_name())
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderDetails', 'CONSTRAINT', N'UQ__WorkOrde__64263250642E9F87'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-738454153', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderDetails', 'CONSTRAINT', N'UQ__WorkOrde__64263250642E9F87'
GO
