$PBExportHeader$w_armada_mitchell.srw
forward
global type w_armada_mitchell from Window
end type
end forward
...
global w_armada_mitchell w_armada_mitchell
...
PrintSend ( ll_Label, cEsc + "V630" + cEsc + "H1145" + cEsc + "M" + "MITCHELL PLASTICS" )
...
//PrintSend ( ll_Label, cEsc + "V631" + cEsc + "H346" + cEsc + "M" + "LOT NUMBER" )
PrintSend ( ll_Label, cEsc + "V650" + cEsc + "H300" + cEsc + "M" + "(1T)" )
PrintSend ( ll_Label, cEsc + "V625" + cEsc + "H470" + cEsc + "WL1" + String(lSerial))
PrintSend ( ll_Label, cEsc + "V670" + cEsc + "H300" + cEsc + "B103095" + "*" + "1T" + String(lSerial) + "*")
...
on w_armada_mitchell.create
end on

on w_armada_mitchell.destroy
end on
