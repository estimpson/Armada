$PBExportHeader$w_armada_gm_b10-1.srw
forward
global type w_armada_gm_b10-1 from Window
end type
end forward
...
global w_armada_gm_b10-1 w_armada_gm_b10-1
...
PrintSend ( ll_label, lc_esc + "H930" + lc_esc + "V265" + lc_esc + "$A,100,100,0" + lc_esc + "$=" + ls_line_11 )
...
PrintSend ( ll_label, lc_esc + "H455" + lc_esc + "V675" + lc_esc + "L0101" + lc_esc + "OB" + String ( ldt_date, "mm/dd/yyyy") )
...
PrintSend ( ll_label, lc_esc + "H860" + lc_esc + "V460" + lc_esc + "$A,75,75,0" + lc_esc + "$=" + ls_line12 )
...
PrintSend ( ll_label, lc_esc + "H860" + lc_esc + "V545" + lc_esc + "L0101" + lc_esc + "M" + ls_line13 )
PrintSend ( ll_label, lc_esc + "H860" + lc_esc + "V570" + lc_esc + "L0101" + lc_esc + "M" + ls_line14 )
PrintSend ( ll_label, lc_esc + "H860" + lc_esc + "V595" + lc_esc + "L0101" + lc_esc + "M" + ls_line15 )

//ZONE_CODE,LINE_FEED & CUSTOM03(FROM ORDER_DETAIL)
PrintSend ( ll_label, lc_esc + "H860" + lc_esc + "V640" + lc_esc + "L0101" + lc_esc + "M" +  ls_line16 )
...
on w_armada_gm_b10-1.create
end on

on w_armada_gm_b10-1.destroy
end on
