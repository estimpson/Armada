$PBExportHeader$w_armada_1_generic.srw
forward
global type w_armada_1_generic from Window
end type
end forward
...
global w_armada_1_generic w_armada_1_generic
...
on w_armada_1_generic.create
end on

on w_armada_1_generic.destroy
end on
