$PBExportHeader$w_armada_generic_key.srw
$PBExportComments$Armada's generic label for Key Plastics.
forward
global type w_armada_generic_key from Window
end type
end forward
...
global w_armada_generic_key w_armada_generic_key
...
PrintSend ( ll_Label, cEsc + "V288" + cEsc + "H900" + cEsc + "M" + "(O)" )
PrintSend ( ll_Label, cEsc + "V270" + cEsc + "H940" + cEsc + "$A,85,105,0" + cEsc +"$=" + upper(String(sz_custpo)) )
PrintSend ( ll_Label, cEsc + "V359" + cEsc + "H900" + cEsc + "B103095" + "*" +"O" + upper(String(sz_custpo)) + "*" )

PrintSend ( ll_Label, cEsc + "V480" + cEsc + "H0905" + cEsc + "$A,35,40,0" + cEsc + "$=" + sz_zone_code)
PrintSend ( ll_Label, cEsc + "V530" + cEsc + "H0905" + cEsc + "$A,35,40,0" + cEsc + "$=" + sz_line_feed_code )
...
PrintSend ( ll_Label, cEsc + "V705" + cEsc + "H0905" + cEsc + "M" + "INT.PART NO." )
PrintSend ( ll_Label, cEsc + "V720" + cEsc + "H0905" + cEsc + "$A,35,40,0" + cEsc + "$=" + upper(String(szTemp)) )
PrintSend ( ll_Label, cEsc + "V705" + cEsc + "H1150" + cEsc + "M" + "DESCRIPTION" )
PrintSend ( ll_Label, cEsc + "V720" + cEsc + "H1150" + cEsc + "$A,35,40,0" + cEsc + "$=" + s_name )
...
on w_armada_generic_key.create
end on

on w_armada_generic_key.destroy
end on
