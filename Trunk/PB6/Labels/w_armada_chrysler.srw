$PBExportHeader$w_armada_chrysler.srw
$PBExportComments$armada chrysler label 4/18
forward
global type w_armada_chrysler from Window
end type
end forward
...
global w_armada_chrysler w_armada_chrysler
...
PrintSend ( l_Label, c_Esc + "V310" + c_Esc + "H1145" + c_Esc + "$A,40,40,0" + c_Esc + "$=" + sz_obj_shipper) 
PrintSend ( l_Label, c_Esc + "V263" + c_Esc + "H1145" + c_Esc + "M" + "SHIPPER" )
...
PrintSend ( l_Label, c_Esc + "V631" + c_Esc + "H943" + c_Esc + "M" + "Armada #" )
...
PrintSend ( l_Label, c_Esc + "V245" + c_Esc + "H619" + c_Esc + "FW03H0115")
...
on w_armada_chrysler.create
end on

on w_armada_chrysler.destroy
end on
