$PBExportHeader$w_bwa_gm1724.srw
forward
global type w_bwa_gm1724 from Window
end type
end forward
...
global w_bwa_gm1724 w_bwa_gm1724
...
END IF
  ...
  SELECT	order_header.customer_part,
	 ...
	 INTO	:ls_customer_part,
			...
			:ls_add_6,
			:ls_supplier_code
     FROM order_header, object, destination, edi_setups
...
//DLOC
PrintSend ( ll_label, lc_esc + "H920" + lc_esc + "V140" + lc_esc + "L0102" + "DLOC" )
PrintSend ( ll_label, lc_esc + "H730" + lc_esc + "V990" + lc_esc + "$A,75,75,0" + lc_esc + "$=" + ls_dock_code )
...
//PrintSend ( ll_label, lc_esc + "H860" + lc_esc + "V460" + lc_esc + "$A,50,50,0" + lc_esc + "$=" + ls_name )
...
on w_bwa_gm1724.create
end on

on w_bwa_gm1724.destroy
end on
