$PBExportHeader$w_armada_toyota.srw
forward
global type w_armada_toyota from Window
end type
end forward
...
global w_armada_toyota w_armada_toyota
...
PrintSend ( l_Label, c_Esc + "V359" + c_Esc + "H300" + c_Esc + "B103095" + "*" +"Q" + String(dec_Quantity) + "*" )

PrintSend ( l_Label, c_Esc + "V263" + c_Esc + "H715" + c_Esc + "M" + "DOCK CODE" )
PrintSend ( l_Label, c_Esc + "V300" + c_Esc + "H715" + c_Esc + "$A,100,110,0" + c_Esc +"$=" + s_DOCKCODE )

//KANBAN NO.
PrintSend ( l_Label, c_Esc + "V263" + c_Esc + "H943" + c_Esc + "M" + "KANBAN NUMBER" )
PrintSend ( l_Label, c_Esc + "V300" + c_Esc + "H943" + c_Esc + "$A,120,140,0" + c_Esc +"$=" + s_linefeed )
...
PrintSend ( l_Label, c_Esc + "V479" + c_Esc + "H953" + c_Esc + "M" + "DESCRIPTION" )
PrintSend ( l_Label, c_Esc + "V510" + c_Esc + "H953" + c_Esc + "OB"  + S_TEMP )

PrintSend ( l_Label, c_Esc + "V560" + c_Esc + "H953" + c_Esc + "M"  + "MGF. DATE" )
PrintSend ( l_Label, c_Esc + "V585" + c_Esc + "H953" + c_Esc + "OB"  + string(dDate) )
...
PrintSend ( l_Label, c_Esc + "V668" + c_Esc + "H350" + c_Esc + "B102095" + "*" + "S" + String(l_Serial) + "*")

PrintSend ( l_Label, c_Esc + "V780" + c_Esc + "H325" + c_Esc + "M" + szCompany + "  " + szAddress1 + " " + szAddress2 + "  " + szAddress3 )

PrintSend ( l_Label, c_Esc + "V631" + c_Esc + "H943" + c_Esc + "M" + "STORE ADDRESS" )
PrintSend ( l_Label, c_Esc + "V635" + c_Esc + "H949" + c_Esc + "$A,115,140,0" + c_Esc +"$="  + UPPER(s_ZONE) )
...
PrintSend ( l_Label, c_Esc + "V030" + c_Esc + "H550" + c_Esc + "FW03V0465" )
PrintSend ( l_Label, c_Esc + "V720" + c_Esc + "H254" + c_Esc + "FW03H0215")
...
on w_armada_toyota.create
end on

on w_armada_toyota.destroy
end on
