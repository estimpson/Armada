$PBExportHeader$w_armada_gm_parts.srw
forward
global type w_armada_gm_parts from Window
end type
end forward
...
global w_armada_gm_parts w_armada_gm_parts
...
on w_armada_gm_parts.create
end on

on w_armada_gm_parts.destroy
end on
