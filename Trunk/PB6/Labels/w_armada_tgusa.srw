$PBExportHeader$w_armada_tgusa.srw
forward
global type w_armada_tgusa from Window
end type
end forward
...
global w_armada_tgusa w_armada_tgusa
...
PrintSend ( l_Label, c_Esc + "V300" + c_Esc + "H735" + c_Esc + "$A,075,075,0" + c_Esc +"$=" + s_DOCKCODE )
...
PrintSend ( l_Label, c_Esc + "V510" + c_Esc + "H933" + c_Esc + "OB"  + S_TEMP )

PrintSend ( l_Label, c_Esc + "V560" + c_Esc + "H933" + c_Esc + "M"  + "MGF. DATE" )
PrintSend ( l_Label, c_Esc + "V585" + c_Esc + "H933" + c_Esc + "OB"  + string(dDate) )

//PrintSend ( l_Label, c_Esc + "V631" + c_Esc + "H300" + c_Esc + "M" + "LOT/SERIAL" )
PrintSend ( l_Label, c_Esc + "V652" + c_Esc + "H280" + c_Esc + "M" + "(S)" )
PrintSend ( l_Label, c_Esc + "V625" + c_Esc + "H500" + c_Esc + "WL1" + String(l_Serial))
PrintSend ( l_Label, c_Esc + "V672" + c_Esc + "H280" + c_Esc + "B103095" + "*" + "S" + String(l_Serial) + "*")
...
on w_armada_tgusa.create
end on

on w_armada_tgusa.destroy
end on
