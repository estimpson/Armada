$PBExportHeader$w_armada_generic.srw
$PBExportComments$armada generic label for blanket order - 5/22
forward
global type w_armada_generic from Window
end type
end forward
...
global w_armada_generic w_armada_generic
...
PrintSend ( ll_Label, cEsc + "V520" + cEsc + "H300" + cEsc + "B103095" + "*" + "V" + String(szSupplier + "*" ))
...
on w_armada_generic.create
end on

on w_armada_generic.destroy
end on
