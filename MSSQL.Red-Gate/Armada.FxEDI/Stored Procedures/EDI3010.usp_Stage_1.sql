...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingShipScheduleHeaders'

	insert
		FxArmada.EDI3010.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingShipScheduleSupplemental'
	
	insert 
		FxArmada.EDI3010.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingShipScheduleAccums'

	insert  FxArmada.EDI3010.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingShipScheduleAuthAccums'

	insert
		FxArmada.EDI3010.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingShipSchedules'

	insert
		FxArmada.EDI3010.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingPlanningHeaders'

	insert
		FxArmada.EDI3010.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxArmada.EDI3010.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingPlanningAccums'

	insert
		FxArmada.EDI3010.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingPlanningAuthAccums'

	insert
		FxArmada.EDI3010.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3010.StagingPlanningReleases'

	insert
		FxArmada.EDI3010.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	FxArmada.EDI3010.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxArmada.EDI3010.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxArmada.EDI3010.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxArmada.EDI3010.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxArmada.EDI3010.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxArmada.EDI3010.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxArmada.EDI3010.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxArmada.EDI3010.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxArmada.EDI3010.StagingPlanningSupplemental sfa
