...
/*			- prepare Ship Schedules Headers.*/
	...
	,	DocType = ed.Type
	,	Version
	,	ReleaseNo = coalesce(nullif(ed.fullData.value('(/TRN-862/SEG-BSS/DE[@code="0328"])[1]', 'varchar(30)'),''), ed.fullData.value('(/TRN-862/SEG-BSS/DE[@code="0127"])[1]', 'varchar(30)'))
	,	DocNumber
	,	ControlNumber
...
/*			- prepare Release Plans Supplemental.*/
	...
	select
		RawDocumentGUID = ed.RawDocumentGUID
	,	ReleaseNo = coalesce(nullif(ed.FullData.value('(/TRN-830/SEG-BFR/DE[@code="0328"])[1]', 'varchar(30)'),''), ed.FullData.value('(/TRN-830/SEG-BFR/DE[@code="0127"])[1]', 'varchar(30)'))
	,	ShipToCode = coalesce(EDIData.Releases.value('(./LOOP-N1/SEG-N1 [DE[.="MA"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'),ed.fullData.value('(/TRN-830/LOOP-N1/SEG-N1 [DE[.="ST"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'), ed.fulldata.value('/*[1]/TRN-INFO[1]/@trading_partner', 'varchar(50)'))
	...
	,	CustomerPart = ed.Data.value('(	for $a in LOOP-LIN/SEG-LIN/DE[@code="0235"] where $a="BP" return $a/../DE[. >> $a][@code="0234"][1])[1]', 'varchar(30)')
	,	CustomerPO = ed.Data.value('(	for $a in LOOP-LIN/SEG-LIN/DE[@code="0235"] where $a="PO" return $a/../DE[. >> $a][@code="0234"][1])[1]', 'varchar(30)')
	,	CustomerPOLine = ed.Data.value('(	for $a in LOOP-LIN/SEG-LIN/DE[@code="0235"] where $a="PO" return $a/../DE[. >> $a][@code="0234"][1])[1]', 'varchar(30)')
	,	CustomerModelYear = left(releaseno,1)
	,	MoparPartNumber =  ed.Data.value('(	for $a in LOOP-LIN/SEG-LIN/DE[@code="0235"] where $a="VP" return $a/../DE[. >> $a][@code="0234"][1])[1]', 'varchar(30)')
	from
		@PlanningSupplementalTemp1 ed
		cross apply ed.data.nodes('/LOOP-LIN') as EDIData(Data)
	order by
		2
	,	3
	,	7
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingShipScheduleHeaders'

	insert
		FxArmada.EDICHRY.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingShipScheduleSupplemental'
	
	insert 
		FxArmada.EDICHRY.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingShipScheduleAccums'

	insert  FxArmada.EDICHRY.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingShipScheduleAuthAccums'

	insert
		FxArmada.EDICHRY.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingShipSchedules'

	insert
		FxArmada.EDICHRY.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingPlanningHeaders'

	insert
		FxArmada.EDICHRY.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxArmada.EDICHRY.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingPlanningAccums'

	insert
		FxArmada.EDICHRY.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingPlanningAuthAccums'

	insert
		FxArmada.EDICHRY.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDICHRY.StagingPlanningReleases'

	insert
		FxArmada.EDICHRY.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	insert 
		FxArmada.EDICHRY.StagingPlanningMoparPartNumber
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	FxArmada.EDICHRY.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxArmada.EDICHRY.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxArmada.EDICHRY.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxArmada.EDICHRY.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxArmada.EDICHRY.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxArmada.EDICHRY.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxArmada.EDICHRY.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxArmada.EDICHRY.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxArmada.EDICHRY.StagingPlanningSupplemental sfa
