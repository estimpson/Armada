...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingShipScheduleHeaders'

	insert
		FxArmada.EDI3030.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingShipScheduleSupplemental'
	
	insert 
		FxArmada.EDI3030.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingShipScheduleAccums'

	insert  FxArmada.EDI3030.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingShipScheduleAuthAccums'

	insert
		FxArmada.EDI3030.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingShipSchedules'

	insert
		FxArmada.EDI3030.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingPlanningHeaders'

	insert
		FxArmada.EDI3030.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxArmada.EDI3030.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingPlanningAccums'

	insert
		FxArmada.EDI3030.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingPlanningAuthAccums'

	insert
		FxArmada.EDI3030.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDI3030.StagingPlanningReleases'

	insert
		FxArmada.EDI3030.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	FxArmada.EDI3030.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxArmada.EDI3030.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxArmada.EDI3030.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxArmada.EDI3030.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxArmada.EDI3030.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxArmada.EDI3030.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxArmada.EDI3030.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxArmada.EDI3030.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxArmada.EDI3030.StagingPlanningSupplemental sfa
