...
CREATE PROCEDURE [EDIFACT96A_MU].[usp_Stage_1]
...
--- <Update rows="*">
set	@TableName = 'EDIFACT96A_MU.vwPlanningReleasesHeaders'
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingShipScheduleHeaders'

	insert
		FxArmada.EDIFACT96A_MU.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingShipScheduleSupplemental'
	
	insert 
		FxArmada.EDIFACT96A_MU.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingShipScheduleAccums'

	insert  FxArmada.EDIFACT96A_MU.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
    ...
    ,   LastAccumQty = max(case when QuantityQualifier in ('70' ) then coalesce(nullif(Quantity,''),0) when QuantityQualifier = '3' THEN coalesce(nullif(Quantity,''),0) else 0  end)
    ,   LastAccumDT = max(
					case 
				  ...
				  then dbo.udf_GetDT('CCYYMMDDHHMM', coalesce(nullif(DateDT, '00000000'), '209901010001')) 
					...
					when QuantityQualifier = '3'  and datalength(DateDT) = 8
					then dbo.udf_GetDT('CCYYMMDD', coalesce(nullif(DateDT, '00000000'), '20990101')) 
					when QuantityQualifier = '3' and datalength(DateDT) = 12
					then dbo.udf_GetDT('CCYYMMDDHHMM', coalesce(nullif(DateDT, '00000000'), '209901010001'))
					when QuantityQualifier = '3' 
					then case coalesce(DateDTFormat,'')
					when '102' Then dbo.udf_GetDT('CCYYMMDD', coalesce(nullif(DateDT, '00000000'), '20990101'))
					when '103' Then dbo.udf_GetDT('CCYYWW', coalesce(nullif(DateDT, '00000000'), '209901'))
					when '203' Then dbo.udf_GetDT('CCYYMMDDHHMM', coalesce(nullif(DateDT, '00000000'), '209901010001'))
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingShipScheduleAuthAccums'

	insert
		FxArmada.EDIFACT96A_MU.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingShipSchedules'

	insert
		FxArmada.EDIFACT96A_MU.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingPlanningHeaders'

	insert
		FxArmada.EDIFACT96A_MU.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxArmada.EDIFACT96A_MU.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingPlanningAccums'

	insert
		FxArmada.EDIFACT96A_MU.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingPlanningAuthAccums'

	insert
		FxArmada.EDIFACT96A_MU.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDIFACT96A_MU.StagingPlanningReleases'

	insert
		FxArmada.EDIFACT96A_MU.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
SET	@Result = 100
	RAISERROR ('97A documents already in process.  Use EDIFACT96A_MU.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	RETURN
...
execute
	@ProcReturn = EDIFACT96A_MU.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxArmada.EDIFACT96A_MU.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxArmada.EDIFACT96A_MU.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxArmada.EDIFACT96A_MU.StagingShipScheduleAccums sfs

Select 'StagingSSAuthAccums'
select 
	*
from
	FxArmada.EDIFACT96A_MU.StagingShipScheduleAuthAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxArmada.EDIFACT96A_MU.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxArmada.EDIFACT96A_MU.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxArmada.EDIFACT96A_MU.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxArmada.EDIFACT96A_MU.StagingPlanningAccums sfa

Select 'PlanningAuthAccums'	
select 
	*
from
	FxArmada.EDIFACT96A_MU.StagingPlanningAuthAccums sfa
Select 'PlanningSupplemental'	
select 
	*
from
	FxArmada.EDIFACT96A_MU.StagingPlanningSupplemental sfa
