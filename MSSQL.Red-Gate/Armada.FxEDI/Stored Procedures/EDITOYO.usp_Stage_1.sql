...
CREATE procedure [EDITOYO].[usp_Stage_1]
...
--Begin Transaction
	...
	select
		RawDocumentGUID
	,	ReleaseNo = coalesce(ed.fullData.value('(/TRN-862/SEG-BSS/DE[@code="0328"])[1]', 'varchar(30)'), ed.fullData.value('(/TRN-862/SEG-BSS/DE[@code="0127"])[1]', 'varchar(30)'))
	,	ShipToCode = coalesce(EDIData.Releases.value('(./SEG-REF [DE[.="DK"][@code="0128"]]/DE[@code="0127"])[1]', 'varchar(50)'), EDIData.Releases.value('(../SEG-N1 [DE[.="MI"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'),ed.fullData.value('(/TRN-862/LOOP-N1/SEG-N1 [DE[.="MI"][@code="0098"]]/DE[@code="0093"])[1]', 'varchar(50)'))
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingShipScheduleHeaders'

	insert
		FxArmada.EDITOYO.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingShipScheduleSupplemental'
	
	insert 
		FxArmada.EDITOYO.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingShipScheduleAccums'

	insert  FxArmada.EDITOYO.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingShipScheduleAuthAccums'

	insert
		FxArmada.EDITOYO.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingShipSchedules'

	insert
		FxArmada.EDITOYO.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingPlanningHeaders'

	insert
		FxArmada.EDITOYO.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxArmada.EDITOYO.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingPlanningAccums'

	insert
		FxArmada.EDITOYO.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingPlanningAuthAccums'

	insert
		FxArmada.EDITOYO.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDITOYO.StagingPlanningReleases'

	insert
		FxArmada.EDITOYO.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Update rows="*">
	set	@TableName = 'EDITOYO.ShipScheduleHeaders'
...
set	@Result = 100
	raiserror ('Chrysler documents already in process.  Use EDITOYO.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	return
...
execute
	@ProcReturn = EDITOYO.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxArmada.EDITOYO.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxArmada.EDITOYO.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxArmada.EDITOYO.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxArmada.EDITOYO.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxArmada.EDITOYO.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxArmada.EDITOYO.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxArmada.EDITOYO.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxArmada.EDITOYO.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxArmada.EDITOYO.StagingPlanningSupplemental sfa
