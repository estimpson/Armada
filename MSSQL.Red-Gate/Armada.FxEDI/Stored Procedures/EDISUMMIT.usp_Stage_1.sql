...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingShipScheduleHeaders'

	insert
		FxArmada.EDISUMMIT.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingShipScheduleSupplemental'
	
	insert 
		FxArmada.EDISUMMIT.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingShipScheduleAccums'

	insert  FxArmada.EDISUMMIT.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingShipScheduleAuthAccums'

	insert
		FxArmada.EDISUMMIT.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingShipSchedules'

	insert
		FxArmada.EDISUMMIT.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingPlanningHeaders'

	insert
		FxArmada.EDISUMMIT.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxArmada.EDISUMMIT.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingPlanningAccums'

	insert
		FxArmada.EDISUMMIT.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingPlanningAuthAccums'

	insert
		FxArmada.EDISUMMIT.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxArmada.EDISUMMIT.StagingPlanningReleases'

	insert
		FxArmada.EDISUMMIT.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	FxArmada.EDISUMMIT.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxArmada.EDISUMMIT.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxArmada.EDISUMMIT.StagingShipScheduleAccums sfs

Select 'StagingSSAuthAccums'
select 
	*
from
	FxArmada.EDISUMMIT.StagingShipScheduleAuthAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxArmada.EDISUMMIT.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxArmada.EDISUMMIT.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxArmada.EDISUMMIT.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxArmada.EDISUMMIT.StagingPlanningAccums sfa

Select 'PlanningAuthAccums'	
select 
	*
from
	FxArmada.EDISUMMIT.StagingPlanningAuthAccums sfa
Select 'PlanningSupplemental'	
select 
	*
from
	FxArmada.EDISUMMIT.StagingPlanningSupplemental sfa
