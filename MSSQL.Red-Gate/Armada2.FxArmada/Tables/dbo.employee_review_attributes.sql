CREATE TABLE [dbo].[employee_review_attributes]
(
...
GO
ALTER TABLE [dbo].[employee_review_attributes] ADD CONSTRAINT [pk_employee_review_attributes] PRIMARY KEY CLUSTERED  ([employee], [scheduled_date]) ON [PRIMARY]
GO
