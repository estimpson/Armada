...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MES_Group__RowCr__15DBD50B] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__MES_Group__RowMo__16CFF944] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__MES_Group__RowMo__17C41D7D] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'MES_GroupTechnologyBackflushingPrinciples', 'CONSTRAINT', N'UQ__MES_Grou__A9A9A0521022FBB5'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1152892912', 'SCHEMA', N'dbo', 'TABLE', N'MES_GroupTechnologyBackflushingPrinciples', 'CONSTRAINT', N'UQ__MES_Grou__A9A9A0521022FBB5'
GO
