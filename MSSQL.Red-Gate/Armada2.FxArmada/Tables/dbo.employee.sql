...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'employee', 'CONSTRAINT', N'UQ__employee__6E2DBEDE245D67DE'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-799080539', 'SCHEMA', N'dbo', 'TABLE', N'employee', 'CONSTRAINT', N'UQ__employee__6E2DBEDE245D67DE'
GO
