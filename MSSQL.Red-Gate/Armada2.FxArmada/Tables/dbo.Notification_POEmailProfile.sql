...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Notificat__RowCr__1FC466A1] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__Notificat__RowMo__20B88ADA] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Notificat__RowMo__21ACAF13] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'Notification_POEmailProfile', 'CONSTRAINT', N'UQ__Notifica__3B2960C91546D82E'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1591097436', 'SCHEMA', N'dbo', 'TABLE', N'Notification_POEmailProfile', 'CONSTRAINT', N'UQ__Notifica__3B2960C91546D82E'
GO
