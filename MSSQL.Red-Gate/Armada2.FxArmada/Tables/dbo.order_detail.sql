...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__order_det__RowCr__12BADEFE] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NULL CONSTRAINT [DF__order_det__RowCr__13AF0337] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__order_det__RowMo__14A32770] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NULL CONSTRAINT [DF__order_det__RowMo__15974BA9] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
create trigger [dbo].[tr_order_detail_uRowModified] on [dbo].[order_detail] after update
as
declare
	@TranDT datetime
,	@Result int
