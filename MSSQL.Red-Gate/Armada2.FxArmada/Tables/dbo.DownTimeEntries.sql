...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__DownTimeE__RowCr__44B5F42E] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__DownTimeE__RowMo__45AA1867] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__DownTimeE__RowMo__469E3CA0] DEFAULT (suser_name())
) ON [PRIMARY]
GO
