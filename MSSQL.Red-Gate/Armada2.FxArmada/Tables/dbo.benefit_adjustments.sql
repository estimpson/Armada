CREATE TABLE [dbo].[benefit_adjustments]
(
...
[benefit_type] [varchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[benefit_adjustments] ADD CONSTRAINT [pk_benefit_adjustments] PRIMARY KEY CLUSTERED  ([employee], [payroll_date], [entry_datetime], [adjustment_identity]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [benefit_adj_cycle_employee] ON [dbo].[benefit_adjustments] ([payroll_cycle], [employee], [voucher]) ON [PRIMARY]
GO
