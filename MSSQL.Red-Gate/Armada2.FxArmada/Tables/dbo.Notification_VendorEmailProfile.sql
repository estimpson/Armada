...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Notificat__RowCr__257D3FF7] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__Notificat__RowMo__26716430] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Notificat__RowMo__27658869] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'Notification_VendorEmailProfile', 'CONSTRAINT', N'UQ__Notifica__425147D40E99DA9F'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-167626285', 'SCHEMA', N'dbo', 'TABLE', N'Notification_VendorEmailProfile', 'CONSTRAINT', N'UQ__Notifica__425147D40E99DA9F'
GO
