CREATE TABLE [dbo].[budget_balance_status]
(
...
GO
ALTER TABLE [dbo].[budget_balance_status] ADD CONSTRAINT [pk_budget_balance_status] PRIMARY KEY CLUSTERED  ([fiscal_year], [ledger], [balance_name]) ON [PRIMARY]
GO
