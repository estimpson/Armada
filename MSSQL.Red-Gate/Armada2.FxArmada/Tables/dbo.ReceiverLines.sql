...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ReceiverL__LastU__15A53433] DEFAULT (suser_sname()),
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'ReceiverLines', 'CONSTRAINT', N'UQ__Receiver__8C51A4C310E07F16'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-2410291609', 'SCHEMA', N'dbo', 'TABLE', N'ReceiverLines', 'CONSTRAINT', N'UQ__Receiver__8C51A4C310E07F16'
GO
