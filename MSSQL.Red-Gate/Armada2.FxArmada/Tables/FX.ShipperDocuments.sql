...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ShipperDo__LastU__58F12BAE] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__ShipperDo__LastD__59E54FE7] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__ShipperDo__RowGU__5AD97420] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperDocuments', 'CONSTRAINT', N'UQ__ShipperD__B174D9DD53385258'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-763294493', 'SCHEMA', N'FX', 'TABLE', N'ShipperDocuments', 'CONSTRAINT', N'UQ__ShipperD__B174D9DD53385258'
GO
