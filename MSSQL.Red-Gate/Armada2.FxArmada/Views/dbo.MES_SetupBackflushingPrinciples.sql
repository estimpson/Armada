...
,	'Part:  ' + p.part
,	p.name
,	BackflushingPrinciple = coalesce(mpbp.BackflushingPrinciple, mgtbp.BackflushingPrinciple, mplbp.BackflushingPrinciple, mcbp.BackflushingPrinciple, convert(int, defaultBackflushPrinciple.Value))
,	DefaultType =
	case
...
,	DefaultBackflushingPrinciple = coalesce(mgtbp.BackflushingPrinciple, mplbp.BackflushingPrinciple, mcbp.BackflushingPrinciple, convert(int, defaultBackflushPrinciple.Value))
from
	dbo.part p
	...
	left join Fx.Globals defaultBackflushPrinciple
		on defaultBackflushPrinciple.Name = 'MES.DefaultBackflushPrinciple'
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'VIEW', N'MES_SetupBackflushingPrinciples', 'TRIGGER', N'trMES_SetupBackflushingPrinciples'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-2326942980', 'SCHEMA', N'dbo', 'VIEW', N'MES_SetupBackflushingPrinciples', 'TRIGGER', N'trMES_SetupBackflushingPrinciples'
GO
