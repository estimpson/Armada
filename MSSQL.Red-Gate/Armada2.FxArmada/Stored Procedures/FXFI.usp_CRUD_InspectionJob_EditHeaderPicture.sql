...
create procedure [FXFI].[usp_CRUD_InspectionJob_EditHeaderPicture]
	@User varchar(5)
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_EditHeaderPicture
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@PictureID = @PictureID
,	@TranDT = @TranDT out
