...
create procedure [FXFI].[usp_CRUD_InspectionJob_EditHeaderNote]
	@User varchar(5)
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_EditHeaderNote
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@NoteID = @NoteID
,	@TranDT = @TranDT out
