...
create procedure [FXFI].[usp_CRUD_InspectionJob_SetHeaderInspectionStatus]
	@User varchar(5)
...
begin
	...
	begin try
		...
		--- <Body>
		/*	Set status of objects. */
		set @TocMsg = 'Set status of objects'
		begin
			--- <Update rows="*">
...
,	@InspectionStatus varchar(50) = 'SCAN COMPLETE'
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_SetHeaderInspectionStatus
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@InspectionStatus = @InspectionStatus
,	@TranDT = @TranDT out
