...
where	(order_detail.destination  like 'AF52M%' or order_detail.destination  like 'R3MSA%' or order_detail.destination like '%F201C%')  and order_detail.due_date >= dateadd(dd, -60, getdate())
order by 4 ,7
SET TRANSACTION ISOLATION LEVEL
read committed 
end
