...
create procedure [FXFI].[usp_CRUD_InspectionJob_CancelObjectNote]
	@User varchar(5)
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_CancelObjectNote
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@Serial = @Serial
,	@NoteID = @NoteID
