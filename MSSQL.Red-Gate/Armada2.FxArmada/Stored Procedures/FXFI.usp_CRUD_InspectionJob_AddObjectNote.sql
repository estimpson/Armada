...
create procedure [FXFI].[usp_CRUD_InspectionJob_AddObjectNote]
	@User varchar(5)
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_AddObjectNote
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@Serial = @Serial
,	@Note = @Note
...
select
	@InspectionJobNumber, @NoteID, @Error, @ProcReturn, @TranDT, @ProcResult
