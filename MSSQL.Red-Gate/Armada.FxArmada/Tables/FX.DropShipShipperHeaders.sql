...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__DropShipS__LastU__0F824689] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__DropShipS__LastD__10766AC2] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__DropShipS__RowGU__116A8EFB] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'DropShipShipperHeaders', 'CONSTRAINT', N'UQ__DropShip__B174D9DD0ABD916C'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-2073887078', 'SCHEMA', N'FX', 'TABLE', N'DropShipShipperHeaders', 'CONSTRAINT', N'UQ__DropShip__B174D9DD0ABD916C'
GO
