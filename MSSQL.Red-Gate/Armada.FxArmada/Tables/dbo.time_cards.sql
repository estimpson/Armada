...
/** 11/16/2018 Modified to remove payroll_date from the SELECT statement in the cursor.
		payroll_date can be changed so this was not working when the user changed the payroll_date.
		Now that we have the identity column, using the identity column makes it unique.
