...
(
[PackingJobNumber] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__PackingJo__Packi__512493F3] DEFAULT ('0'),
[QualityBatchNumber] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Status] [int] NOT NULL CONSTRAINT [DF__PackingJo__Statu__530CDC65] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__PackingJob__Type__5401009E] DEFAULT ((0)),
...
[PackingOperator] [varchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__PackingJo__RowCr__54F524D7] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__PackingJo__RowCr__55E94910] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__PackingJo__RowMo__56DD6D49] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__PackingJo__RowMo__57D19182] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
*/
GO
ALTER TABLE [FXPL].[PackingJobHeaders] ADD CONSTRAINT [PK__PackingJ__FFEE74513CEE16D4] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
ALTER TABLE [FXPL].[PackingJobHeaders] ADD CONSTRAINT [UQ__PackingJ__BD32CCC20884F1FE] UNIQUE NONCLUSTERED  ([PackingJobNumber]) ON [PRIMARY]
GO
ALTER TABLE [FXPL].[PackingJobHeaders] ADD CONSTRAINT [FK__PackingJo__Quali__5218B82C] FOREIGN KEY ([QualityBatchNumber]) REFERENCES [dbo].[InventoryControl_QualityBatchHeaders] ([QualityBatchNumber])
GO
