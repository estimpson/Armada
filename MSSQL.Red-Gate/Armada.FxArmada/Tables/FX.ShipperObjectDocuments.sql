...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ShipperOb__LastU__758D6A5C] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__ShipperOb__LastD__76818E95] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__ShipperOb__RowGU__7775B2CE] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperObjectDocuments', 'CONSTRAINT', N'UQ__ShipperO__B174D9DD6EE06CCD'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-923192624', 'SCHEMA', N'FX', 'TABLE', N'ShipperObjectDocuments', 'CONSTRAINT', N'UQ__ShipperO__B174D9DD6EE06CCD'
GO
