...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Backflush__RowCr__01B4E0CD] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__Backflush__RowMo__02A90506] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Backflush__RowMo__039D293F] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'BackflushDetails', 'CONSTRAINT', N'UQ__Backflus__6625724D7B07E33E'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-53258908', 'SCHEMA', N'dbo', 'TABLE', N'BackflushDetails', 'CONSTRAINT', N'UQ__Backflus__6625724D7B07E33E'
GO
