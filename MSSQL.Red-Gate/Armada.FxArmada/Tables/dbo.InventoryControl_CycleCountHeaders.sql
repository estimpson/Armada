...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Inventory__RowCr__21C28903] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__Inventory__RowMo__22B6AD3C] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Inventory__RowMo__23AAD175] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'InventoryControl_CycleCountHeaders', 'CONSTRAINT', N'UQ__Inventor__2888CBAE192D4302'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-1702195955', 'SCHEMA', N'dbo', 'TABLE', N'InventoryControl_CycleCountHeaders', 'CONSTRAINT', N'UQ__Inventor__2888CBAE192D4302'
GO
