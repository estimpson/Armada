CREATE TABLE [dbo].[tax_rate_basis]
(
...
GO
ALTER TABLE [dbo].[tax_rate_basis] ADD CONSTRAINT [pk_tax_rate_basis] PRIMARY KEY CLUSTERED  ([tax_type], [basis_document], [basis_document_type]) ON [PRIMARY]
GO
