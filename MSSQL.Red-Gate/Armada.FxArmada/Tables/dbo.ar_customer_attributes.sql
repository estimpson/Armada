CREATE TABLE [dbo].[ar_customer_attributes]
(
...
GO
ALTER TABLE [dbo].[ar_customer_attributes] ADD CONSTRAINT [pk_ar_customer_attributes] PRIMARY KEY CLUSTERED  ([customer]) ON [PRIMARY]
GO
