...
(
[QualityBatchNumber] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__Inventory__Quali__61DDD96F] DEFAULT ('0'),
[Status] [int] NOT NULL CONSTRAINT [DF__Inventory__Statu__62D1FDA8] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__InventoryC__Type__63C621E1] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__Inventory__RowCr__64BA461A] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__Inventory__RowCr__65AE6A53] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__Inventory__RowMo__66A28E8C] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__Inventory__RowMo__6796B2C5] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
begin try
	...
	if	not update(RowModifiedDT) begin
		...
		from
			dbo.InventoryControl_QualityBatchHeaders QualityBatchNumber
			join inserted i
				on i.RowID = QualityBatchNumber.RowID
...
deallocate
	newRows
GO
ALTER TABLE [dbo].[InventoryControl_QualityBatchHeaders] ADD CONSTRAINT [PK__Inventor__FFEE7450348085E9] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[InventoryControl_QualityBatchHeaders] ADD CONSTRAINT [UQ__Inventor__B7E9D44647B831A3] UNIQUE CLUSTERED  ([QualityBatchNumber]) ON [PRIMARY]
GO
