...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowCr__1334728A] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__WorkOrder__RowMo__142896C3] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowMo__151CBAFC] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[WorkOrderObjects] ADD CONSTRAINT [FK__WorkOrderObjects__1610DF35] FOREIGN KEY ([WorkOrderNumber], [WorkOrderDetailLine]) REFERENCES [dbo].[WorkOrderDetails] ([WorkOrderNumber], [Line])
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderObjects', 'CONSTRAINT', N'UQ__WorkOrde__1A00E0930B9350C2'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1377014515', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderObjects', 'CONSTRAINT', N'UQ__WorkOrde__1A00E0930B9350C2'
GO
