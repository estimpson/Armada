...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ShipperHe__LastU__673F4B05] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__ShipperHe__LastD__68336F3E] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__ShipperHe__RowGU__69279377] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperHeaders', 'CONSTRAINT', N'UQ__ShipperH__B174D9DD636EBA21'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-1152558719', 'SCHEMA', N'FX', 'TABLE', N'ShipperHeaders', 'CONSTRAINT', N'UQ__ShipperH__B174D9DD636EBA21'
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperHeaders', 'CONSTRAINT', N'UQ__ShipperH__ED0F8CBF60924D76'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-122485050', 'SCHEMA', N'FX', 'TABLE', N'ShipperHeaders', 'CONSTRAINT', N'UQ__ShipperH__ED0F8CBF60924D76'
GO
