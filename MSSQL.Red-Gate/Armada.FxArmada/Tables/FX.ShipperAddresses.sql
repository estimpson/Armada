...
[LastUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__ShipperAd__LastU__3F3159AB] DEFAULT (suser_sname()),
[LastDT] [datetime] NOT NULL CONSTRAINT [DF__ShipperAd__LastD__40257DE4] DEFAULT (getdate()),
[RowID] [int] NOT NULL IDENTITY(1, 1),
[RowGUID] [uniqueidentifier] NULL CONSTRAINT [DF__ShipperAd__RowGU__4119A21D] DEFAULT (newid())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'FX', 'TABLE', N'ShipperAddresses', 'CONSTRAINT', N'UQ__ShipperA__B174D9DD3A6CA48E'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'1466700857', 'SCHEMA', N'FX', 'TABLE', N'ShipperAddresses', 'CONSTRAINT', N'UQ__ShipperA__B174D9DD3A6CA48E'
GO
