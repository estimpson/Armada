...
[RowCreateUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowCr__5244F976] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__WorkOrder__RowMo__53391DAF] DEFAULT (getdate()),
[RowModifiedUser] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__WorkOrder__RowMo__542D41E8] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'SVN_Revision', N'$Rev$', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderHeaders', 'CONSTRAINT', N'UQ__WorkOrde__1FA44F964B97FBE7'
GO
EXEC sp_addextendedproperty N'T_Checksum', N'-429479274', 'SCHEMA', N'dbo', 'TABLE', N'WorkOrderHeaders', 'CONSTRAINT', N'UQ__WorkOrde__1FA44F964B97FBE7'
GO
