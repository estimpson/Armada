...
create procedure [FXFI].[usp_CRUD_InspectionJob_EditObjectNote]
	@User varchar(5)
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_EditObjectNote
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@Serial = @Serial
,	@NoteID = @NoteID
