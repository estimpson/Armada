...
Create PROCEDURE [dbo].[usp_ShipNotice_Faurecia_backup_original]  (@shipper INT)
AS
BEGIN
...
DECLARE
	...
	@NADQual92 CHAR(3) = '92',
	@SealNumber CHAR(10),
	@NADQualCN CHAR(3) = 'CN' , --Consignee (destination)
	@NADQualSE CHAR(3)  ='SE', --Supplier
	@NADQualCZ CHAR(3)  ='CZ',
	@NADCOO CHAR(3)  ='US',
					...
					SELECT  '17' 
							...
							WHILE
								...
								END
									...
									INSERT	#ASNFlatFile (LineData)
									SELECT  '18' +  @PartPackCount + Space(3) + @PackageType + @NADQual92 + @PartPackQty 
									
									INSERT	#ASNFlatFile (LineData)
									SELECT  '19' +  @PCIQualifier
