...
CREATE procedure [EDIFACT96A_MU].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIFACT96A_MU.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningReleases'
...
insert
	EDIFACT96A_MU.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIFACT96A_MU.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIFACT96A_MU.ShipScheduleSupplemental'

insert
	EDIFACT96A_MU.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFACT96A_MU.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFACT96A_MU.ShipScheduleAccums'

insert
	EDIFACT96A_MU.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFACT96A_MU.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFACT96A_MU.ShipScheduleAuthAccums'

insert
	EDIFACT96A_MU.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFACT96A_MU.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFACT96A_MU.ShipSchedules'

insert
	EDIFACT96A_MU.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIFACT96A_MU.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIFACT96A_MU.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIFACT96A_MU.PlanningSupplemental'

insert
	EDIFACT96A_MU.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFACT96A_MU.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFACT96A_MU.PlanningAccums'

insert
	EDIFACT96A_MU.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFACT96A_MU.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFACT96A_MU.PlanningAuthAccums'

insert
	EDIFACT96A_MU.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFACT96A_MU.StagingPlanningAuthAccumsT 
...
insert
	EDIFACT96A_MU.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDIFACT96A_MU.StagingPlanningReleasesT sfr
...
truncate table
	EDIFACT96A_MU.StagingShipScheduleHeadersT
truncate table
	EDIFACT96A_MU.StagingShipScheduleSupplementalT
truncate table
	EDIFACT96A_MU.StagingShipScheduleAccumsT
truncate table
	EDIFACT96A_MU.StagingShipScheduleAuthAccumsT
truncate table
	EDIFACT96A_MU.StagingShipSchedulesT
truncate table
	EDIFACT96A_MU.StagingPlanningHeadersT
truncate table
	EDIFACT96A_MU.StagingPlanningSupplementalT
truncate table
	EDIFACT96A_MU.StagingPlanningAccumsT
truncate table
	EDIFACT96A_MU.StagingPlanningAuthAccumsT
truncate table
	EDIFACT96A_MU.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFACT96A_MU.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIFACT96A_MU.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIFACT96A_MU.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIFACT96A_MU.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIFACT96A_MU.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIFACT96A_MU.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIFACT96A_MU.ShipSchedules sdrv
...
select
	*
from
	EDIFACT96A_MU.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIFACT96A_MU.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIFACT96A_MU.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIFACT96A_MU.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIFACT96A_MU.PlanningReleases sdrv
go
