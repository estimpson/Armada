...
create procedure [FXFI].[usp_CRUD_InspectionJob_EditObjectPicture]
	@User varchar(5)
...
begin
	...
	begin try
		...
		/*	Edit object picture. */
		set @TocMsg = 'Edit object picture'
		begin
			--- <Update rows="1">
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_EditObjectPicture
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@Serial = @Serial
,	@PictureID = @PictureID
