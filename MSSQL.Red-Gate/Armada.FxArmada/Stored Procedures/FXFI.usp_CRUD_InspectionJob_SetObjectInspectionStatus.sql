...
create procedure [FXFI].[usp_CRUD_InspectionJob_SetObjectInspectionStatus]
	@User varchar(5)
	...
	begin try
		...
		begin
			...
			update
				ijo
			set
				ijo.InspectionStatus = @InspectionStatus
			from
...
declare
	@User varchar(5) = 'EES'
,	@InspectionJobNumber varchar(50) = 'PJ_000000039'
,	@Serial integer = 1844096
,	@InspectionStatus varchar(50) = 'SCANNED'
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_SetObjectInspectionStatus
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@InspectionStatus = @InspectionStatus
,	@Serial = @Serial
