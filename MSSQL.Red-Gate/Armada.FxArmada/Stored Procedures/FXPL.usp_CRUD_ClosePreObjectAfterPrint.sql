...
create procedure [FXPL].[usp_CRUD_ClosePreObjectAfterPrint]
	@User varchar(5)
,	@Serial int
,	@Printed bit = 1
...
begin
	...
	begin try
		...
		--- <Body>
		/*	Set printed flag, closed status. */
...
execute
	@ProcReturn = FXPL.usp_CRUD_ClosePreObjectAfterPrint
	@User = @User
,	@Serial = @Serial
,	@Printed = @Printed
,	@TranDT = @TranDT out
