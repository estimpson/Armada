...
create procedure [FXFI].[usp_CRUD_InspectionJob_CancelHeaderNote]
	@User varchar(5)
...
execute
	@ProcReturn = FXFI.usp_CRUD_InspectionJob_CancelHeaderNote
	@User = @User
,	@InspectionJobNumber = @InspectionJobNumber
,	@NoteID = @NoteID
,	@TranDT = @TranDT out
