...
create procedure [FXFI].[usp_Q_CompletedPackingJobs]
	...
	begin try
		...
		begin
			select
				result =
					coalesce
					(	FXFI.udf_Q_CompletedPackingJobs(),
						convert(xml, '<CompletedPackingJob></CompletedPackingJob>')
					)
...
execute
	@ProcReturn = FXFI.usp_Q_CompletedPackingJobs
	@TranDT = @TranDT out
