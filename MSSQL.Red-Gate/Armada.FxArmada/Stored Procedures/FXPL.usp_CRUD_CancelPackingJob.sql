...
create procedure [FXPL].[usp_CRUD_CancelPackingJob]
	@User varchar(5)
...
begin
	...
	begin try
		...
		begin
			...
			where
				woh.WorkOrderNumber = @PackingJobNumber
...
declare
	@User varchar(5) = 'EES'
,	@PackingJobNumber varchar(50) = 'PJ_000000027'
...
execute
	@ProcReturn = FXPL.usp_CRUD_CancelPackingJob
	@User = @User
,	@PackingJobNumber = @PackingJobNumber
,	@TranDT = @TranDT out
